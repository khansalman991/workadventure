...
## [index.d.ts](https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/bigbluebutton-js/index.d.ts)
````ts
...
# Credits
These definitions were written by [Marcos Kintschner](https://github.com/mktn87).
