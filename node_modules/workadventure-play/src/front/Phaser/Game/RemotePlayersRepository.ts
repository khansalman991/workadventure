...
export class RemotePlayersRepository {
    ...
    private getPlayerDeferred = new Map<number, DeferredModule.Deferred<RemotePlayerData>>();
    ...
    public getPlayer(userId: number): Promise<RemotePlayerData> {
        ...
        let deferred: DeferredModule.Deferred<RemotePlayerData> | undefined = this.getPlayerDeferred.get(userId);
        if (!deferred) {
