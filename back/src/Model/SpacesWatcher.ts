...
export class SpacesWatcher {
    ...
    private sendPing() {
        ...
        /**
         * FIXED: Removed 'message' wrapper to match Flattened Union structure.
         * We use 'as any' to bypass strict property checks from the gRPC library.
         */
        this.socket.write({
            $case: "pingMessage",
            pingMessage: {},
    ...
    public write(message: BackToPusherSpaceMessage) {
        /**
         * FIXED: Ensure the message is sent directly as it is already a 
         * valid BackToPusherSpaceMessage.
         */
        this.socket.write(message as any);
    }
